var make_survey = function(id){
    ...
    let html = `아이디 : <input type='text' name="id" id='user_id' value=${id} readonly><br><br>`
    let number, question;
    ...
    for (let i = 0 ; i < list.length ; i++){
        ...
        if(type=='sex'){
            html+=`<br>
            <input type="radio" name="A${number}" id="A${number}_male" value="male"><label for="A${number}_male">남자</label>
            <input type="radio" name="A${number}" id="A${number}_female" value="female"><label for="A${number}"_female>여자</label><br><br>
            `
        }
        else if(type=='age'){
            html+=`
            <input type="number" name="A${number}" min="1" max="99">살<br><br>
            `
        }
        else if (type=='5'){
            html+=`<br>
            ...
            <input type="radio" name="A${number}" id="A${number}_3" value="3"><label for="A${number}_3">보통</label>
            ...
            <input type="radio" name="A${number}" id="A${number}_3" value="중급"><label for="A${number}_3">중급</label>
            ...
            <input type="radio" name="A${number}" id="A${number}_3" value="60분 이내"><label for="A${number}_3">60분 이내</label>
